...
namespace VeraWAF.WebPages.Controls
{
    ...
    /// </remarks>
    public partial class UserLastActiveDate : UserFieldControlBase
    {
        /// <summary>
        /// Vera base page 
        /// </summary>
        ...
        /// <summary>
        /// Add the last activity date to the user control.
        /// </summary>
        /// <remarks>
        ...
        protected override void FillControlFields(MembershipUser user)
        {
            ...
            LastActivity.InnerText = dateUtils.GetReadableDate(user.LastActivityDate);
            LastActivity.Attributes["datetime"] = dateUtils.GetCustomIso8601Date(user.LastActivityDate);
        }
