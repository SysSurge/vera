/*! Readme: /Terms.aspx . Rel: 10/9/2014 7:43:15 AM UTC *//*
...
$(document).ready(function(){var d=$(window);var c=$("html, body");var a=$(document);var b=$("form");$("img.jail").show().jail({effect:"fadeIn"});$("time.timeAgo").each(function(){$(this).timeAgo()});$("div.inputBox").each(function(){$(this).inputBox()})});/* Vera VAF 1.0 license: https://github.com/sparkledb/vera */
